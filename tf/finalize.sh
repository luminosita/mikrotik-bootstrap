...
scp -P 2222 $TF_VAR_adminuser@$TF_VAR_host:/cert_export_chat-server@MikroTik.crt ../certs/server.crt
scp -P 2222 $TF_VAR_adminuser@$TF_VAR_host:/cert_export_chat-server@MikroTik.key ../certs/server.key
